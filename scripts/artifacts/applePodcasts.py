...
def get_applePodcasts(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if usageentries > 0:
            ...
            tsvname = 'Apple Podcasts - Shows'
            tsv(report_folder, data_headers, data_list, tsvname)

            tlactivity = 'Apple Podcasts - Shows'
        ...
        if usageentries > 0:
            ...
            tsvname = 'Apple Podcasts - Episodes'
            tsv(report_folder, data_headers, data_list, tsvname)

            tlactivity = 'Apple Podcasts - Episodes'
            timeline(report_folder, tlactivity, data_list, data_headers)
        else:

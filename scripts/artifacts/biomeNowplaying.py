...
def get_biomeNowplaying(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        while True:
            ...
            if check != b'\x00':
                ...
                if (protostuff.get('14', '')) == '':
                    output = ''
                elif isinstance(protostuff['14'], dict):
        ...
        if data_list:
            ...
            description = ''
            report = ArtifactHtmlReport('Biome Now Playing Public')
            ...
            tsvname = f'Biome Now Playing Public - {filename}'
            tsv(report_folder, data_headers, data_list, tsvname) # TODO: _csv.Error: need to escape, but no escapechar set

            tlactivity = f'Biome Now Playing Public - {filename}'
            timeline(report_folder, tlactivity, data_list, data_headers)

        else:
            logfunc('No data available for Biome Now Playing Public')

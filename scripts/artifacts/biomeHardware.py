...
def get_biomeHardware(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if data_list:
            ...
            description = ''
            report = ArtifactHtmlReport('Biome Hardware Reliability')
            ...
            logfunc('No data available for Biome Hardware Reliability')

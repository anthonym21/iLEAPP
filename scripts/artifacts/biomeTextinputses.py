...
def get_biomeTextinputses(files_found, report_folder, seeker, wrap_text):
    ...
    for file_found in files_found:
        ...
        if data_list:
            ...
            description = ''
            report = ArtifactHtmlReport('Biome Text Input Sessions')
            ...
            tsvname = f'Biome Text Input Sessions - {filename}'
            tsv(report_folder, data_headers, data_list, tsvname) # TODO: _csv.Error: need to escape, but no escapechar set

            tlactivity = f'Biome Text Input Sessions - {filename}'
            timeline(report_folder, tlactivity, data_list, data_headers)

        else:
            logfunc('No data available for Biome Text Input Sessions')
